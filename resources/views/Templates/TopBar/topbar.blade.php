    ...
    <ul class="list-unstyled topnav-menu float-right mb-0">
        ...
        <li class="dropdown d-none d-lg-block">
            ...
            <div class="dropdown-menu dropdown-menu-right">
                ...
                <!-- item-->
                <a href="javascript:void(0);" class="dropdown-item notify-item">
                    <img src="{{ asset('assets/images/flags/french.jpg') }}" alt="user-image" class="mr-2" height="12"> <span class="align-middle">French</span>
                </a>
        ...
        <li class="dropdown notification-list">
            <a class="nav-link dropdown-toggle nav-user mr-0" data-toggle="dropdown" href="#" role="button" aria-haspopup="false" aria-expanded="false">
                ...
                <span class="pro-user-name ml-1">
                                    {{ $OnlineCustomer->full_name }}  <i class="mdi mdi-chevron-down"></i>
                            </span>
            </a>
...
<div class="left-side-menu">
    ...
    <div class="user-box">
        ...
        <div class="user-info">
            <a href="#">{{ $OnlineCustomer->full_name }}</a>
            <p class="text-muted m-0">Master</p>
        </div>
    </div>
    ...
    <div id="sidebar-menu">
        ...
        <ul class="metismenu" id="side-menu">
            ...
            <li>
                <a href="/backlink/seo/backlink/order/">
